...
CREATE TABLE `order_details` (
  ...
  `serial_versionuid` bigint DEFAULT NULL,
...
CREATE TABLE `products` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `detai_desc` mediumtext NOT NULL,
...
--
-- Dumping events for database 'laptop_shop'
--

--
-- Dumping routines for database 'laptop_shop'
--
...
-- Dump completed on 2025-12-22 21:04:32
