                                    ...
                                    <form:select class="form-select" path="role.name">
                                        ...
                                        <form:option value="USER">USER</form:option>
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="roleDesc" readonly />
                                                </div>
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function () {
                        ...
                        if (!roleSelect || !roleDesc) {
                            console.error("Không tìm thấy element roleSelect hoặc roleDesc");
                            return;
                        }

                        function updateDescription() {
                            roleDesc.value = roleDescMap[roleSelect.value] || "";
                        }

                        roleSelect.addEventListener("change", updateDescription);

                        // Hiển thị ngay khi load trang (edit form)
                        updateDescription();
                    });
                </script>
