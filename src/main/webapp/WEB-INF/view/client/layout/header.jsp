                ...
                <div class="d-flex justify-content-between">
                    <div class="top-info ps-2">
                        <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#"
                                class="text-white">132
                                Cầu Diễn</a></small>
                        <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#"
                                class="text-white">hozinium@gmail.com</a></small>
                    </div>
                    <div class="top-link pe-2">
                        ...
                        <a href="#" class="text-white"><small class="text-white ms-2">Bán hàng và trả hàng</small></a>
                    </div>
                </div>
            </div>
                    ...
                    <a href="contact.html" class="nav-item nav-link">Contact</a> -->
                        ...
                        <div class="d-flex m-3 me-0">
                            <c:if test="${not empty pageContext.request.userPrincipal}">
                                <!-- giỏ hàng -->
                                <a href="<c:url value='/cart'/>" class="position-relative me-4 my-auto">
