...
public class ItemController {
    ...
    public String deleteCartDetail(@PathVariable long id, HttpServletRequest request) {
        ...
        this.iProductService.handleRemoveCartDetail(cartDetailId, session);
    ...
    public String getCheckOutPage(@ModelAttribute("cart") Cart cart) {
        List<CartDetail> cartDetails = cart == null ? new ArrayList<CartDetail>() : cart.getCartDetails();
        this.iProductService.handleUpdateCartBeforeCheckout(cartDetails);
    ...
    public String handlePlaceOrder(
        ...
        this.iProductService.handlePlaceOrder(currentUser, session, receiverName, receiverAddress, receiverPhone);
    ...
    public String handleAddProductFromViewDetail(
        ...
        String email = (String) session.getAttribute("email");
        this.iProductService.handleAddProductToCart(email, id, session, quantity);
